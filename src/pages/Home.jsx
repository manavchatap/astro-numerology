  ...
  return (
    <div className="home-container">
        ...
        <div className="hero-content">
          ...
          <div className="cta-buttons">
            <Link to="/numerology" className="cta-btn primary-btn">
              <span className="btn-icon">Ì¥¢</span>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            <div className="feature-icon">Ìºü</div>
          ...
          <div className="feature-card">
            <div className="feature-icon">Ìºô</div>
          ...
          <div className="feature-card">
            <div className="feature-icon">Ì¥Æ</div>
      ...
      <footer className="footer">
        <p>‚ú® Built with ancient wisdom and modern technology ‚ú®</p>
